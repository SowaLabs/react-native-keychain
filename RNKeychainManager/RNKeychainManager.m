...
RCT_EXPORT_METHOD(getGenericPasswordForOptions:(NSDictionary *)options withOtherOptions:(NSDictionary *)unusedOptions resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
  NSString *service = serviceValue(options);
